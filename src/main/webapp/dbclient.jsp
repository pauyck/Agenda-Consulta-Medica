							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="url" class="form-control input-sm"
											placeholder="URL JDBC"
											title="Exemplo: jdbc:derby:db;create=true" value="<%=url%>">
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input type="text" name="user" class="form-control input-sm"
											placeholder="Usuário" value="<%=user%>">
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
								...
								<div class="col-sm-2">
									<div class="form-group">
										...
										<input type="text" name="max" class="form-control input-sm"
											placeholder="# Máx. registros"
											title="Quantidade máxima de registros" value="<%=max%>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										...
										<textarea name="sql" class="form-control" rows="8"
											placeholder="SQL"><%=sql%></textarea>
									</div>
